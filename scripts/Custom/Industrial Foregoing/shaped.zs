...
<recipetype:industrialforegoing:dissolution_chamber>.addJsonRecipe("golden_heart", {
  "type": "industrialforegoing:dissolution_chamber",
  "input": [
    {
    ...
    {
      "item": "third_life_plus:temporary_life"
    },
    {
      "item": "minecraft:gold_ingot"
    },
  ...
  "inputFluid": "{Amount:540,FluidName:\"industrialforegoing:ether_gas\"}",
  "output": {
    "count": 1,
