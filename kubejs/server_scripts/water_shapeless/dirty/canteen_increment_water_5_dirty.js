...
filling(
  // output
  Item.of('thirstcanteen:leather_canteen_full', '{Damage:0,Purity:0}'),
  // waterInput
  Item.of('minecraft:potion', '{Potion:"minecraft:water",Purity:0}'),
  // canteenInput
  Item.of('thirstcanteen:leather_canteen_full', '{Damage:1,Purity:0}')
)
...
filling(
  ...
  Item.of('minecraft:potion', '{Potion:"minecraft:water",Purity:0}'),
  // canteenInput
  Item.of('thirstcanteen:leather_canteen_full', '{Damage:2,Purity:0}')
)
...
filling(
  ...
  Item.of('minecraft:potion', '{Potion:"minecraft:water",Purity:0}'),
  // canteenInput
  Item.of('thirstcanteen:leather_canteen_full', '{Damage:3,Purity:0}')
)
...
filling(
  ...
  Item.of('minecraft:potion', '{Potion:"minecraft:water",Purity:0}'),
  // canteenInput
  Item.of('thirstcanteen:leather_canteen_full', '{Damage:7,Purity:0}')
)
