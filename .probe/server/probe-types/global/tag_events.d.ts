...
function tags(extra: "lostcities:scattered", handler: (event: TagEventProbe<(Special.ScatteredTag), (Special.Scattered)>) => void): void
function tags(extra: "lostcities:buildings", handler: (event: TagEventProbe<(Special.BuildingsTag), (Special.Buildings)>) => void): void
...
function tags(extra: "lostcities:worldstyles", handler: (event: TagEventProbe<(Special.WorldstylesTag), (Special.Worldstyles)>) => void): void
function tags(extra: "lostcities:predefinedspheres", handler: (event: TagEventProbe<(Special.PredefinedspheresTag), (Special.Predefinedspheres)>) => void): void
function tags(extra: "lostcities:multibuildings", handler: (event: TagEventProbe<(Special.MultibuildingsTag), (Special.Multibuildings)>) => void): void
function tags(extra: "lostcities:stuff", handler: (event: TagEventProbe<(Special.StuffTag), (Special.Stuff)>) => void): void
function tags(extra: "lostcities:variants", handler: (event: TagEventProbe<(Special.VariantsTag), (Special.Variants)>) => void): void
function tags(extra: "moonlight:map_markers", handler: (event: TagEventProbe<(Special.MapMarkersTag), (Special.MapMarkers)>) => void): void
function tags(extra: "lostcities:citystyles", handler: (event: TagEventProbe<(Special.CitystylesTag), (Special.Citystyles)>) => void): void
function tags(extra: "lostcities:parts", handler: (event: TagEventProbe<(Special.PartsTag), (Special.Parts)>) => void): void
function tags(extra: "mekanism:robit_skin", handler: (event: TagEventProbe<(Special.RobitSkinTag), (Special.RobitSkin)>) => void): void
function tags(extra: "lostcities:conditions", handler: (event: TagEventProbe<(Special.ConditionsTag), (Special.Conditions)>) => void): void
function tags(extra: "lostcities:styles", handler: (event: TagEventProbe<(Special.StylesTag), (Special.Styles)>) => void): void
function tags(extra: "lostcities:predefinedcites", handler: (event: TagEventProbe<(Special.PredefinedcitesTag), (Special.Predefinedcites)>) => void): void
function tags(extra: "lostcities:palettes", handler: (event: TagEventProbe<(Special.PalettesTag), (Special.Palettes)>) => void): void
}
}