...
declare module "packages/dev/latvian/mods/kubejs/thermal/$ThermalRecipeJS" {
...
export class $ThermalRecipeJS extends $RecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ThermalRecipeJS$Type = ($ThermalRecipeJS);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $ThermalRecipeJS_ = $ThermalRecipeJS$Type;
}}
...
public "handler$bfo000$loadJavaClass"(name0: string, warn: boolean, cir: $CallbackInfoReturnable$Type<(any)>): void
...
(inventory: $InventoryKJS$Type, title: $Component$Type): void
}
